...
# Path to ChromaDB - we'll use a specific path for the connection
...
# --- Initialize ChromaDB client using st.connection ---
try:
    # Pass the configuration for PersistentClient with the path to the database
...
    st.error(f"Error connecting to the ChromaDB database: {e}.")
    st.stop()
...
    # Retrieve facts from ChromaDB using the connection
